...
class CompraApp(App):
    ...
    def build(self):
        ...
        self.result_label = Label(text="", size_hint_y=None, height=40, color=(1, 1, 1, 1)) # Etiqueta para mostrar el resultado
        button = Button(text="Calcular total", size_hint_y=None, height=50, background_color=(0.1, 0.6, 0.3, 1)) # Botón para calcular el total
